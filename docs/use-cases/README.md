...
| UC-002-03 | 점프 방향 튜닝 | Implemented | [문서](./UC-002-03-tune-jump-direction.md) | 2026-07-05 |
...
| UC-010-01 | 스테이지 전체를 세로 고화질 이미지로 저장 | Verified | [문서](./UC-010-01-capture-stage-as-portrait-image.md) | 2026-07-15 |
